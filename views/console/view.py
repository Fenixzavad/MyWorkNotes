...
class ViewConsoleBasic:
    ...
    def show_all_notes(self):
        ...
        if notes_list == []:
            self.util.show_text("Нет заметок")
    ...
    def run_select_menu(self):
        ...
        while True:
            ...
            if answer == 0:
                ...
                self.util.show_text("Введите Id заметки")
                num = self.util.get_number(min= 1)
                if num != -1:
                    notes_list.append(self.controller.get_note_by_id(id= num))
            elif answer == 2:
                text = input("Введите дату или часть даты в формате д.м.г-ч:м:с например 08.05 или 05.2023\n")
            ...
            if text == "" and num == 0:
                self.util.show_text('Нет запроса')
            elif notes_list == []:
                self.util.show_text("Нет заметок")
            else:
                self.util.show_notes_list(list= notes_list)
        ...
        while True:
            ...
            if answer == 0:
                ...
                if num != -1:
                    ...
                    if note.get_id() == 0:
                        self.util.show_text('Нет заметки с таким Id ')
                    else:
    ...
    def run_update(self):
        num: int = 0
        while True:
            self.util.show_text("Введите Id заметки или 0 для возврата в главное меню")
            ...
            if answer == 0:
                ...
                if note.get_id() == 0:('Нет заметки с таким Id ')
                else:
